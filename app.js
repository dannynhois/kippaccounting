...
app.use("/", express.static(path.join(__dirname, "public"), { maxAge: 1 })); // originaal maxAge:31557600000
app.use(
  "/js/lib",
...
app.get("/codingsolution/:school?", codingSolutionController.getCodingSolution);
